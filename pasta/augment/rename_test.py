...
class RenameTest(test_utils.TestCase):
  ...
  def test_rename_external_in_import(self):
    ...
    self.checkAstsEqual(
        t, ast.parse('import xxx.yyy.ccc\nxxx.yyy.ccc.foo()'))

    t = ast.parse(src)
    self.assertTrue(
        rename.rename_external(t, 'aaa.bbb.ccc', 'xxx.yyy'))
    self.checkAstsEqual(
        t, ast.parse('import xxx.yyy\nxxx.yyy.foo()'))
  ...
  def test_rename_external_in_import_with_asname(self):
    ...
    self.assertTrue(rename.rename_external(t, 'aaa.bbb', 'xxx.yyy'))
    self.checkAstsEqual(
        t, ast.parse('import xxx.yyy.ccc as ddd\nddd.foo()'))
  ...
  def test_rename_external_in_import_multiple_aliases(self):
    ...
    self.assertTrue(rename.rename_external(t, 'aaa.bbb', 'xxx.yyy'))
    self.checkAstsEqual(
        t, ast.parse('import aaa, xxx.yyy, xxx.yyy.ccc'))
  ...
  def test_rename_external_in_importfrom(self):
    ...
    self.assertTrue(
        rename.rename_external(t, 'aaa.bbb.ccc', 'xxx.yyy'))
    self.checkAstsEqual(
        t, ast.parse('from xxx.yyy import ddd\nddd.foo()'))
  ...
  def test_rename_external_in_importfrom_alias(self):
    ...
    self.assertTrue(
        rename.rename_external(t, 'aaa.bbb.ccc', 'xxx.yyy'))
    self.checkAstsEqual(
        t, ast.parse('from xxx import yyy\nyyy.foo()'))
  ...
  def test_rename_external_in_importfrom_alias_with_asname(self):
    ...
    self.assertTrue(
        rename.rename_external(t, 'aaa.bbb.ccc', 'xxx.yyy'))
    self.checkAstsEqual(
        t, ast.parse('from xxx import yyy as abc\nabc.foo()'))
